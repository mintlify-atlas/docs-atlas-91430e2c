...
1. **Isometric View** (`/`) - OpenSeadragon-based deep-zoom rendering of the pixel-art isometric NYC map by [@cannoneyed](https://github.com/cannoneyed)
...
<Note>
The isometric view (App.tsx) is the primary interface and is described in detail on this page. For the alternative map view implementation, see [PermitMap Component](/api/components/permit-map).
</Note>
...
- **[MapLibre GL](https://maplibre.org/)** - WebGL-based map rendering for the alternative map view
